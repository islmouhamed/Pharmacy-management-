                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                                    ...
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('/achat/store')}}" method="POST">
                                      {{csrf_field()}}
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                      <input type="date" id="birthday" class="date-picker form-control col-md-7 col-xs-12 has-feedback-right" name="date_achat" required="required" value="<?php echo date('Y-m-j'); ?>">
                                                    </div>
                                                  </div> 
