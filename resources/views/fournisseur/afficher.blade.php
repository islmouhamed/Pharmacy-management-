                ...
                <div class="title_right">
                  <div class="col-md-2 col-sm-2 col-xs-6 form-group pull-right top_search">
                    ...
                    <div class="input-group">
                        <a href="{{url('/fourniseur')}}" class="btn btn-round btn-success btn-sm">
                            ...
                            <tbody>
                              @foreach ( $fournisseur as $fourni )
                                ...
                                <td style="width: 20%">
                                    ...
                                    @if (Auth::guard()->user()->isadmin=='admin')
                                  <form action="{{url('/fourniseur/destroy/'.$fourni->id.'')}}" method="POST">
                                   
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}
                                    
                                    <a href="{{url('/fourniseur/detaille/'.$fourni->id.'')}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i>  </a>
                                    <a href="{{url('/fourniseur/edit/'.$fourni->id.'')}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  </a>
