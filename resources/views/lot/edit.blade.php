                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                                    ...
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('/lot/update/'.$lot->id.'')}}" method="POST">
                                        ...
                                        {{csrf_field()}}
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                              <select class="form-control" id="achat_id" name="achat_id"  required="required"  >
                                                                @foreach ($achats as $achat)
                                                                  ...
                                                                  <?php $t=$achat->id;?>
                                                                  <option value={{$achat->id}} {{$lot->achat->id==$t ? 'selected' :''}}>{{$t}}</option>
                                                          ...
                                                          <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                  <select class="form-control" id="medicament_id" name="medicament_id"  required="required" >
                                                                    ...
                                                                    <?php $t1=$medi->id;?>
                                                                      <option value={{$medi->id}} {{$lot->medicament->id==$t1 ? 'selected' :''}}>{{$medi->nom}}</option>
                                                                    @endforeach
                                                                  </select>
                                                                </div>
                                                              </div>           
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                      <input id="dat-fab" class="date-picker form-control col-md-7 col-xs-12 has-feedback-right" name="date_fab" required="required" type="text" value="{{$lot->Date_Fab}}">
                                                    </div>
                                                  </div> 
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                          <input id="date_per" class="date-picker form-control col-md-7 col-xs-12 has-feedback-right" name="date_per" required="required" type="text" value="{{$lot->Date_pre}}">
                                                        </div>
                                                      </div> 
                                                      ...
                                                      <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                              <input id="prix" class="date-picker form-control col-md-7 col-xs-12 has-feedback-right" name="prix" required="required" type="text" value="{{$lot->prix}}">
                                                            </div>
                                                          </div> 
                                                          ...
                                                          <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                  <input id="qt_a" class="date-picker form-control col-md-7 col-xs-12 has-feedback-right" name="qt_a" required="required" type="text" value="{{$lot->qt_acht}}">
                                                                </div>
                                                              </div> 
